...
{    
    ...
    */
    ...
    public static var textArray:Array<String> = [
        "Fun fact: Vegecri was here.",
        "Thanks to my mom for pushing me.",
        "Play Vs. Mikegoom, cool mod",
        "Did you know deruki is a bitch?",
        "Hello there also u pointless.",
        "FNF: Cool, Myself: Bad >:(",
        "One last pic and ill be gone.",
        "Dave doesn't like traced art.",
        "Stick Bug menu 5 percent.",
        "Deruki is so dumb -Deruki.",
        "Fabricio pasa FLPs joder.",
        "There are 13 Thropies.",
...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    var gameJoltText3:FlxText;
    var whatYouGainTxt:FlxText;
    ...
    override function create()
    {
        ...
        charBop = new FlxSprite(FlxG.width - 800, 100);
        ...
        gamejoltText1 = new FlxText(0, 25, 0, "Gamejolt Log-in!", 40);
        gamejoltText1.screenCenter(X);
        gamejoltText1.x += baseX;
        gamejoltText1.color = FlxColor.fromRGB(255,174,61);
        add(gamejoltText1);

        gamejoltText2 = new FlxText(0, 75, 0, Date.now().toString(), 20);
        ...
        {       
            ...
            gameJoltText3.font = GameJoltInfo.font;
            whatYouGainTxt.font = GameJoltInfo.font;
